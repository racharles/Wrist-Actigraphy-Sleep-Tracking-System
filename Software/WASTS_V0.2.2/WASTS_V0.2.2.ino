...
Collects data from ADXL343 accelerometer using the activity and inactivity HW
interrupts and prints data with timestamps to sd card, serial monitor, and LCD
...
CHANGES: Added an lcd screen for debugging purposes
